...
<div class="email-container">
    ...
    <div class="content">
        ...
        <p>Hemos recibido una solicitud para verificar esta dirección de correo electrónico. Por favor, utiliza el
            siguiente código para completar la verificación:.</p>
        <p>Si fuiste tú, por favor introduce el siguiente código de verificación para continuar con el proceso
            verificación:</p>
